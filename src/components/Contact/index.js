...
function Contact() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (!errorMessage) {
            console.log('Please submit the form', formState)
        }
    };
    const handleChange = (e) => {
        if (e.target.name === 'email') {
            const validIn = validateEmail(e.target.value);
            if (!validIn) {
                setErrorMessage('Invalid email please correct.');
            }else {
                setErrorMessage('');
            }
        }else {
        ...
        if (!errorMessage) {
            ...
            console.log('Hnadle form', formState)
        }
    };
    return (
        <div>
